...
export default function (){
    return(
        ...
        <div className="bg-[#41b3d0] h-[270px] w-[85%] rounded-[10px] mx-[20px] p-[30px] mb-[50px]">
            ...
            <div className="bg-[#eeee58] h-[270px] w-[85%] rounded-[10px] mx-[20px] p-[30px] mb-[50px]">
            <img className='' src={Projects} />
                <p className="text-[23px] font-semibold text-white " >Calculadora de Projetos</p>
                <p className='text-white'>Loja virtual para venda de moveis </p>
            </div>
            <div className="bg-[#ea70f3] h-[270px] w-[85%] rounded-[10px] mx-[20px] p-[30px] mb-[50px]">
            <img className='' src={Projects} />
